...
export const metadata: Metadata = {
  title: "Privacy Policy - VectorMail AI",
  description: "Privacy Policy for VectorMail AI - AI-powered email management platform",
};
      ...
      <div className="container mx-auto px-6 py-16 max-w-4xl">
        ...
        <div className="space-y-8">
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-3 text-black">Definitions</h3>
          ...
          <section className="mb-8">
            ...
            <h4 className="text-lg font-semibold mb-2 text-black">Personal Data</h4>
            <p className="text-gray-700 mb-4 leading-relaxed">
              While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:
            </p>
            <p className="text-gray-700 mb-4 leading-relaxed">
              Email address, First name, Last name, Profile image, Email account data (Gmail integration) & Authentication tokens.
            </p>
            
            <h4 className="text-lg font-semibold mb-2 text-black">Usage Data</h4>
            <p className="text-gray-700 mb-4 leading-relaxed">
            ...
            <h4 className="text-lg font-semibold mb-2 text-black">Tracking Technologies and Cookies</h4>
            <p className="text-gray-700 mb-4 leading-relaxed">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-3 text-black">Business Transactions</h3>
            <p className="text-gray-700 mb-4 leading-relaxed">
              If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
            </p>
            <h3 className="text-xl font-semibold mb-3 text-black">Law enforcement</h3>
            <p className="text-gray-700 mb-4 leading-relaxed">
              Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
            </p>
            <h3 className="text-xl font-semibold mb-3 text-black">Other legal requirements</h3>
            <p className="text-gray-700 mb-4 leading-relaxed">
