  ...
  return (
    <div className="flex w-full items-center gap-2">
      <Select defaultValue={accountId} onValueChange={setAccountId}>
        <SelectTrigger
          className={cn(
            "flex w-full flex-1 items-center gap-2 text-gray-900 dark:text-gray-100 [&>span]:line-clamp-1 [&>span]:flex [&>span]:w-full [&>span]:items-center [&>span]:gap-1 [&>span]:truncate [&>span]:text-gray-900 [&>span]:dark:text-gray-100 [&_svg]:h-4 [&_svg]:w-4 [&_svg]:shrink-0 [&_svg]:text-gray-700 [&_svg]:dark:text-gray-300",
            isCollapsed &&
        ...
        >
          <SelectValue placeholder="Select an account">
            ...
            <span
              className={cn(
                "ml-2 text-gray-900 dark:text-gray-100",
                isCollapsed && "hidden",
              )}
            >
              {
