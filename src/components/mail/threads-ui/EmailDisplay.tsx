...
const EmailDisplay = ({ email }: Props) => {
    ...
    return (
        <div className={cn('border rounded-md p-4 cursor-pointer transition-all hover:translate-x-2 min-h-[600px]', {
            ...
            <Letter className='bg-white rounded-md text-black min-h-[500px] overflow-y-auto' html={email?.body ?? ""} />
        </div>
    )
}
