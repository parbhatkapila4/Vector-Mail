    ...
    replyBody?: string;
      ...
      },
      {
        ...
        body: [
          ...
          "<p style='margin: 0 0 24px 0; font-size: 15px; color: #425466;'>Receipt number: INV-2024-002<br/>Next billing date: March 28, 2025.</p>",
      ...
      },
      {
        ...
        body: email([
          ...
          sectionTitle("When"),
          p("Tuesday, Feb 25, 2025 · 2:00 PM - 2:30 PM (30 min)"),
          sectionTitle("Where"),
      ...
      },
      {
        ...
        body: email([
          ...
          p("Date & time: Feb 26, 2025, 6:42 PM PST<br/>Device: Chrome on Windows<br/>Location: San Francisco, CA, United States<br/>IP address: ••••••••••••"),
      ...
      },
      {
        ...
        body: email([
          ...
          p("Congratulations! The program committee has accepted your talk proposal \"AI for Inbox Zero\" for ProductCon 2025."),
          ...
          companyEmailFooter("ProductCon", { address: "ProductCon 2025 · cfp@conference.io · Reply to this email for speaker questions." }),
        ]),
      ...
      },
      {
        ...
        body: email([
          ...
          p("Thank you for your business. Please find your invoice for February 2025 services below."),
          sectionTitle("Invoice summary"),
          p("Invoice number: INV-2044<br/>Issue date: Feb 15, 2025<br/>Due date: Mar 1, 2025<br/>Amount due: <strong style='color: #0a2540;'>$2,400.00 USD</strong>"),
      ...
      },
      {
        ...
        body: email([
          ...
          p("Your VectorMail subscription is active. Next billing date: March 28, 2025."),
